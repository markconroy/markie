module.exports = {
  ...
  patternLab: {
    ...
    scssToJson: [
      ...
      {
        src: 'source/_patterns/01-basic-elements/01-typography/fonts/_fonts.scss',
        dest: 'source/_patterns/01-basic-elements/01-typography/fonts/font-sizes.json',
        lineStartsWith: '$fs--',
        allowVarValues: false,
      },
      {
        src: 'source/_patterns/01-basic-elements/01-typography/fonts/_fonts.scss',
        dest: 'source/_patterns/01-basic-elements/01-typography/fonts/font-families.json',
        lineStartsWith: '$ff--',
        allowVarValues: false,
      },
      {
  ...
  icons: {
    ...
    templates: {
      ...
      css: {
        ...
        dest: 'source/_patterns/01-basic-elements/images/',
      },
      demo: {
