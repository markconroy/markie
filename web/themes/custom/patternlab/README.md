...
# Annertech Notes - Marky - I need better ones than these, but ...
You NEED the components module - drush dl components && drush en components
git clone this repo
```bash
cd patternlab
npm install
...
npm start
```
go mad - make cool stuff
=== from below here, it's the default README.md that comes with this from Phase 2 ===
