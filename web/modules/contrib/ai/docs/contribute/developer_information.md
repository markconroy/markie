...
- **1.3.x**: This branch is for the next minor release. New features and changes that are backward compatible and non-breaking should be merged here. This branch will eventually become the next stable release.
