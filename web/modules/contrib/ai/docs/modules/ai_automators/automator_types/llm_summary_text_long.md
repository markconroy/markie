...
- **Potential target:** Text Long field

## File location

[ai_automators/src/Plugin/AiAutomatorType/LlmSummarizeToTextLong.php](https://git.drupalcode.org/project/ai/-/blob/1.2.x/modules/ai_automators/src/Plugin/AiAutomatorType/LlmSummarizeToTextLong.php?ref_type=heads)
