 ...
 *     "add-form" = "/automator-chain/add/{automator_chain_type}",
 *     "add-page" = "/automator-chain/add",
 *     "canonical" = "/automator-chain/{automator_chain}",
 *     "edit-form" = "/automator-chain/{automator_chain}",
 *     "delete-form" = "/automator-chain/{automator_chain}/delete",
