...
/**
 * Data transfer output object for object detection output.
 */
class ObjectDetectionOutput implements OutputInterface {

  /**
   * An array of ObjectDetectionItem objects.
   *
   * @var \Drupal\ai\OperationType\ObjectDetection\ObjectDetectionItem[]
   */
   ...
   * The constructor.
   *
   * @param \Drupal\ai\OperationType\ObjectDetection\ObjectDetectionItem[] $normalized
  ...
  /**
   * Returns a array of ObjectDetectionItem objects.
   *
   * @return \Drupal\ai\OperationType\ObjectDetection\ObjectDetectionItem[]
